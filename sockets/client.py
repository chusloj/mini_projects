...
while True:
    ...
    if new_msg:
        print(f"new message header: {msg[:HEADERSIZE]}") # length of the message is indicated in the header, see server.py
    ...
    if len(full_msg) - HEADERSIZE == msglen: # if you've read in the length of the message body + length of the header, that's the whole message
